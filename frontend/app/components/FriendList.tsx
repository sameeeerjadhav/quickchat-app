...
export default function FriendList({
  ...
  if (friends.length === 0) {
    return (
      <div className="p-4 sm:p-8 text-center">
        ...
        } rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center mb-3 sm:mb-4`}>
          <UserPlus className={`${
  ...
  return (
    <div className="space-y-1 sm:space-y-2 p-1 sm:p-2">
      <h3 className={`${
        isMobile ? 'text-xs px-1 mb-1' : 'text-sm px-2 mb-2'
        ...
        >
          ...
          <div className="flex items-center space-x-0.5 sm:space-x-1" ref={menuRef}>
            <button
              ...
              className={`${
                isMobile ? 'p-1.5' : 'p-2'
              } text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors active:scale-95 touch-target`}
              title="Message"
            ...
            {onStartVideoCall && (
              <button
                ...
                className={`${
                  isMobile ? 'p-1.5' : 'p-2'
                } text-gray-500 hover:text-green-600 dark:hover:text-green-400 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors active:scale-95 touch-target`}
                title="Video Call"
            ...
            {!isMobile && (
              <div className="relative">
                <button
                  ...
                  className={`p-2 text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors touch-target`}
                ...
                {showMenuFor === friend._id && (
                  <div className="absolute right-0 top-full mt-1 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 z-20 animate-fade-in">
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
      ...
      {friends.length > 0 && (
        ...
        } border-t border-gray-200 dark:border-gray-800 mt-2 sm:mt-3`}>
