  ...
  if (requests.length === 0) {
    return (
      <div className={`${
        ...
        } rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center mb-3`}>
          <UserPlus className={`${
              ...
              {!isMobile ? (
                ...
                <div className="relative">
                  <button
                    ...
                    className="p-1.5 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors active:scale-95 touch-target"
                  ...
                  {showActionsFor === request._id && (
                    <div className="absolute right-0 top-full mt-1 w-40 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 z-10 animate-fade-in">
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          onAcceptRequest(request._id);
                      ...
                      <button
                        ...
                        className="w-full text-left px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center gap-3 rounded-b-lg"
                      >
