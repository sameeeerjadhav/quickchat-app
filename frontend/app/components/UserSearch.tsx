    ...
    <div className="space-y-3 sm:space-y-4">
      ...
      <div className="relative px-1 sm:px-0">
        ...
        <input
          ...
          className={`w-full ${
            isMobile ? 'pl-9 pr-8 py-2 text-sm' : 'pl-10 pr-9 py-2.5'
          } bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:text-white transition-all duration-200`}
        ...
        {searchQuery && (
          <button
            ...
            className="absolute right-3 top-1/2 transform -translate-y-1/2 p-1 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors touch-target"
          ...
          return (
            <div
              ...
              className={`flex items-center justify-between ${
                isMobile ? 'p-2' : 'p-3'
              } bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 hover:shadow-sm transition-all duration-200 active:scale-[0.995]`}
            >
              <div className="flex items-center space-x-2 sm:space-x-3 flex-1 min-w-0">
                <div className="relative flex-shrink-0">
                  <div className={`${
                    isMobile ? 'h-8 w-8' : 'h-10 w-10'
                  } rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center text-white font-semibold ${
                  ...
                  {/* {user.isOnline && (
                    ...
                    } rounded-full bg-green-500 border-2 border-white dark:border-gray-800`}></div>
                  )} */}
                </div>
                ...
                {!isMobile ? (
                  <div>
                    {status === 'none' && (
                      <button
                        ...
                        className="flex items-center px-3 py-1.5 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 transition-colors text-sm active:scale-95 touch-target"
                  ...
                  <div className="relative">
                    ...
                    {showActionsFor === user._id && (
                      <div className="absolute right-0 top-full mt-1 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 z-10 animate-fade-in">
                        <div className="py-2">
